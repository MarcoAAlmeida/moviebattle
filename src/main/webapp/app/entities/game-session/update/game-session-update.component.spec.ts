...
describe('GameSession Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call GameRound query and add missing value', () => {
      ...
      const gameRound: IGameRound = { id: 44393 };
      gameSession.gameRound = gameRound;
      ...
      const additionalGameRounds = [gameRound];
    ...
    it('Should update editForm', () => {
      const gameSession: IGameSession = { id: 456 };
      const gameRound: IGameRound = { id: 75334 };
      gameSession.gameRound = gameRound;

      activatedRoute.data = of({ gameSession });
      comp.ngOnInit();

      expect(comp.gameRoundsSharedCollection).toContain(gameRound);
