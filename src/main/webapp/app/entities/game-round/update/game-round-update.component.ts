...
export class GameRoundUpdateComponent implements OnInit {
  ...
  protected updateForm(gameRound: IGameRound): void {
    ...
    this.moviesSharedCollection = this.movieService.addMovieToCollectionIfMissing<IMovie>(this.moviesSharedCollection, gameRound.leftId);
  }
  ...
  protected loadRelationshipsOptions(): void {
    ...
    this.movieService
      ...
      .pipe(map((movies: IMovie[]) => this.movieService.addMovieToCollectionIfMissing<IMovie>(movies, this.gameRound?.leftId)))
