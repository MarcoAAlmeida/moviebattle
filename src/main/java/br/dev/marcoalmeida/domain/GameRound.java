...
public class GameRound implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "gameRound" }, allowSetters = true)
    ...
    public void setGameSessionIds(Set<GameSession> gameSessions) {
        if (this.gameSessionIds != null) {
            this.gameSessionIds.forEach(i -> i.setGameRound(null));
        }
        if (gameSessions != null) {
            gameSessions.forEach(i -> i.setGameRound(this));
        }
