...
public class GameSessionResource {
    ...
    public ResponseEntity<GameSession> updateGameSession(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, gameSession.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<GameSession> partialUpdateGameSession(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, gameSession.getId().toString())
        );
    }
    ...
    public ResponseEntity<GameSession> getGameSession(@PathVariable Long id) {
