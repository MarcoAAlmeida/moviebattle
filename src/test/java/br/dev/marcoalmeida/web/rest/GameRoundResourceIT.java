...
class GameRoundResourceIT {
    ...
    public static GameRound createEntity(EntityManager em) {
        GameRound gameRound = new GameRound().userChoice(DEFAULT_USER_CHOICE).correct(DEFAULT_CORRECT);
        return gameRound;
    }
    ...
    public static GameRound createUpdatedEntity(EntityManager em) {
        GameRound gameRound = new GameRound().userChoice(UPDATED_USER_CHOICE).correct(UPDATED_CORRECT);
        return gameRound;
    }
    ...
    void putExistingGameRound() throws Exception {
        ...
        updatedGameRound.userChoice(UPDATED_USER_CHOICE).correct(UPDATED_CORRECT);
    ...
    void partialUpdateGameRoundWithPatch() throws Exception {
        ...
        partialUpdatedGameRound.correct(UPDATED_CORRECT);
    ...
    void fullUpdateGameRoundWithPatch() throws Exception {
        ...
        partialUpdatedGameRound.userChoice(UPDATED_USER_CHOICE).correct(UPDATED_CORRECT);
